...
function App() {
  ...
  useEffect(() => {
    const resTotPagar = calcularTotalPagar(cantidad, meses);
    setTotal(resTotPagar);
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <div className='my-5 space-y-3 bg-gray-50 p-5'>
        ...
        <p className='text-xl text-gray-500 text-center font-bold'>{Math.ceil(pago)}€ Mensuales</p>
      </div>
    </div>
  )
